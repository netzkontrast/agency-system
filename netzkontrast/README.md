...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/1WYBqmGDNl)
...
```sh
npx nx serve netzkontrast
```

To create a production bundle:

```sh
npx nx build netzkontrast
```

To see all available targets to run for a project, run:

```sh
npx nx show project netzkontrast
```

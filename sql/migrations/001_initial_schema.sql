-- Migration 001: Initial Schema for Kohärenz Protokoll
...
CREATE TABLE IF NOT EXISTS question_span (
    question_id UUID REFERENCES questions(id),
...
CREATE INDEX IF NOT EXISTS idx_tags_vector ON tags USING ivfflat (vector vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_questions_type ON questions(type);
CREATE INDEX IF NOT EXISTS idx_answers_question ON answers(question_id);
CREATE INDEX IF NOT EXISTS idx_answers_type ON answers(type);
CREATE INDEX IF NOT EXISTS idx_tag_question_tag ON tag_question(tag_id);
CREATE INDEX IF NOT EXISTS idx_tag_question_question ON tag_question(question_id);
CREATE INDEX IF NOT EXISTS idx_question_span_question ON question_span(question_id);
CREATE INDEX IF NOT EXISTS idx_question_span_span ON question_span(span_id);
CREATE INDEX IF NOT EXISTS idx_persona_thoughts_vector ON persona_thoughts USING ivfflat (vector vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_persona_thoughts_persona ON persona_thoughts(persona_id);
